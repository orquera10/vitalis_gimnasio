...
SECRET_KEY = 'django-insecure-=$dr!jf1ms0in5&7uwl61zohm6=9ok3dm65#6+6gcd80h=(@t$'
...
# Media files (Archivos e imÃ¡genes subidas por usuarios)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# AutenticaciÃ³n y Redirecciones
